...
class HeroDialogRoute<T> extends PageRoute<T> {
  ...
  // this is the buider for creating the widget that will be displayed by the route
  ...
  // This route can be dismissed by tapping outside the dialog
  @override
  ...
  // in this case, it simply returns a child widget as is, without any transition
  @override
  ...
  // This is the semantic label for the barrier. It is used by the screen reading software for visually inpaired users.
  @override
